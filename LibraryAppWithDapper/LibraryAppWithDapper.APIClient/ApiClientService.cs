...
namespace LibraryAppWithDapper.APIClient
{
	public class ApiClientService
	{
		...
		{
			await _httpClient.PostAsJsonAsync<Author>("/api/author", author);
		}
		...
		{
			await _httpClient.PutAsJsonAsync<Author>("/api/author", author);
		}
